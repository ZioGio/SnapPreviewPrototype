...
{
    public sealed partial class Window1Control : UserControl
    {
        public Window1Control()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty isSnappedProperty =
            DependencyProperty.Register("IsSnapped", typeof(bool), typeof(Window1Control), new PropertyMetadata(0));
        ...
        {
            btn_SnapLeft1.AddHandler(PointerPressedEvent, pressedHandlerLeft, true);
            btn_SnapLeft1.AddHandler(PointerReleasedEvent, releasedHandlerLeft, true);
            btn_SnapRight1.AddHandler(PointerPressedEvent, pressedHandlerRight, true);
            btn_SnapRight1.AddHandler(PointerReleasedEvent, releasedHandlerRight, true);
            btn_Maximize1.AddHandler(PointerPressedEvent, pressedHandlerMaximize, true);
            btn_Maximize1.AddHandler(PointerReleasedEvent, releasedHandlerMaximize, true);
        }

        public void Maximized()
        {
            btn_Maximize1.Visibility = Visibility.Collapsed;
            btn_Restore1.Visibility = Visibility.Visible;
        }

        public void Restored()
        {
            btn_Maximize1.Visibility = Visibility.Visible;
            btn_Restore1.Visibility = Visibility.Collapsed;
        }
        ...
        private void Btn_Maximize1_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
            ButtonMaximizePressed?.Invoke(this, e);
        }

        private void Btn_Maximize1_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
